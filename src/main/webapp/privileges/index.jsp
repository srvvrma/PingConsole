			...
			<div class="box box-success">
				...
				<div class="slimScrollDiv"
					...
					<div class="slimScrollBar"
						style="background: rgb(0, 0, 0) none repeat scroll 0% 0%; width: 7px; position: absolute; top: 13px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 187.126px;"></div>
