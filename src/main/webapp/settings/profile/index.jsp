...
<section class="content-header" id="main-breadcrumb">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#"><i class="fa fa-dashboard"></i> Formatter</a></li>
		...
		<div class="col-md-3">
			...
			<div class="box box-skin">
				<div class="box-body box-profile">
					...
					<a href="#" class="btn btn-skin btn-block"><b>Follow</b></a>
				</div>
				<!-- /.box-body -->
			</div>
			<!-- /.box -->
							...
							<div class="row margin-bottom">
								<div class="col-sm-6">
									<img class="img-responsive"
										src="${contextPath}/resources/dist/img/photo1.png" alt="Photo">
								</div>
								<!-- /.col -->
								<div class="col-sm-6">
									<div class="row">
										<div class="col-sm-6">
											<img class="img-responsive"
												src="${contextPath}/resources/dist/img/photo2.png"
												alt="Photo"> <br> <img class="img-responsive"
												src="${contextPath}/resources/dist/img/photo3.jpg"
												alt="Photo">
										</div>
										<!-- /.col -->
										<div class="col-sm-6">
											<img class="img-responsive"
												src="${contextPath}/resources/dist/img/photo4.jpg"
												alt="Photo"> <br> <img class="img-responsive"
												src="${contextPath}/resources/dist/img/photo1.png"
												alt="Photo">
										</div>
										<!-- /.col -->
									</div>
