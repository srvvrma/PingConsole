...
<head>
  ...
  <title><spring:message code="label.application.name" /> | Log in</title>
  ...
  <div class="login-box-body">
    ...
    <span>${message}</span>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="user name" name="username" autofocus="true" />
