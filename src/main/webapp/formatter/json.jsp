...
<section id="main-container" class="content">
		...
		<div class="col-xs-12">
			<div class="box box-skin">
				<div class="box-header">
					<h3 class="box-title">Format JSON</h3>
							...
							<div class="form-group">
								...
								<div class="jsondataholder">
									<textarea rows="8" class="form-control" id="jsondata"
										name="rawJson" style="resize: vertical;"></textarea>
									<div class="btn-group btn-group-sm">
										<button type="button" class="btn btn-link btn-clear btn-sm" onclick="$('#jsondata').val('');">
					...
					<div class="row">
						<div class="col-xs-8 col-md-offset-2 text-center">
							<button type="button" id="process"
								class="btn btn-action btn-lg btn-skin" onclick="formatJSON();"
	...
	<div class="col-xs-12">
          <div class="box box-default">
            ...
            <!-- /.box-header -->
            <div id="jsonData" class="box-body">
              <div class="row">
						<div class="col-xs-2"
							style="margin-top: 70px; text-align: center; display: block;">
						...
						<div class="col-xs-8">
							<div class="form-group">
								<label for="exampleInputFile">Formatted JSON</label>
								<div class="jsondataholder">
									<textarea rows="8" class="form-control" id="jsondataOutput"
										name="jsondata" style="resize: vertical;"></textarea>
									<div class="btn-group btn-group-sm">
										<button type="button" class="btn btn-link btn-clear btn-sm"  onclick="$('#jsondataOutput').val('');">
											<i class="fa fa-trash-o"></i>
										</button>
									</div>
								</div>
